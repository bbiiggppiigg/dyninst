...
namespace Dyninst { namespace InstructionAPI {
  ...
  Expression::Ptr InstructionDecoder_power::makeFallThroughExpr() {
    return makeAddExpression(makeRegisterExpression(ppc64::pc),
                             Immediate::makeImmediate(Result(u32, 4)), u32);
  }

  void InstructionDecoder_power::LI() {
    insn_in_progress->addSuccessor(makeIFormBranchTarget(), field<31, 31>(insn) == 1, false, false,
                                   false);
  }

  void InstructionDecoder_power::BD() {
    insn_in_progress->addSuccessor(makeBFormBranchTarget(), field<31, 31>(insn) == 1, false,
...
**	There are 2 XX1 instructions, the last bit of the extended opcodes are ignored (30th bit,
which are both 0).
    */
    ...
    if(current->op == power_op_b || current->op == power_op_bc || current->op == power_op_bclr ||
      ...
      insn_in_progress->appendOperand(makeRegisterExpression(ppc64::pc), false, true);
    }
    ...
    if(current->op == power_op_bclr) {
      ...
      {
        auto link_register = makeRegisterExpression(ppc64::lr);
      ...
      if(LK == 1) {
        // 1. Do not use bclrl as a subroutine call
        auto lr = makeRegisterExpression(ppc64::lr);
    ...
    if(current->op == power_op_bcctr) {
      ...
      if(LK == 1) {
        ...
        auto ctr = makeRegisterExpression(ppc64::ctr);
  ...
  void InstructionDecoder_power::OE() {
    if(field<21, 21>(insn)) {
      ...
      insn_in_progress->appendOperand(makeRegisterExpression(ppc64::xer), false, true);
  ...
  Expression::Ptr InstructionDecoder_power::makeMemRefIndex(Result_Type size) {
    return makeDereferenceExpression(makeAddExpression(makeRAorZeroExpr(), makeRBExpr(), s32),
                                     size);
  }
  ...
  Expression::Ptr InstructionDecoder_power::makeMemRefNonIndex(Result_Type size) {
    ...
    if(size == u64 || size == s64 || size == dbl128 || field<0, 5>(insn) == 58) {
      return makeDereferenceExpression(makeAddExpression(makeRAorZeroExpr(), makeDSExpr(), s32),
                                       size);
    }
    return makeDereferenceExpression(makeAddExpression(makeRAorZeroExpr(), makeDorSIExpr(), s32),
                                     size);
  }

  Expression::Ptr InstructionDecoder_power::makeRAExpr() {
    return makeRegisterExpression(makePowerRegID(ppc64::r0, field<11, 15>(insn)));
  }
  ...
  Expression::Ptr InstructionDecoder_power::makeRBExpr() {
    return makeRegisterExpression(makePowerRegID(ppc64::r0, field<16, 20>(insn)));
  }
  ...
  void InstructionDecoder_power::FRT2() {
    MachRegister firstRegID = makePowerRegID(ppc64::fpr0, field<6, 10>(insn));
    MachRegister secondRegID = makePowerRegID(ppc64::fpr0, field<6, 10>(insn) + 1);
  ...
  Expression::Ptr InstructionDecoder_power::makeRTExpr() {
    return makeRegisterExpression(makePowerRegID(ppc64::r0, field<6, 10>(insn)));
  }
  ...
  void InstructionDecoder_power::XT() {
    ...
    insn_in_progress->appendOperand(makeRegisterExpression(makePowerRegID(ppc64::vsr0, id)), false,
                                    true);
  }
  ...
  void InstructionDecoder_power::XS() {
    ...
    //       The single T bit is at bit 28, instaed of bit 31.
    unsigned id = field<6, 10>(insn) + 32 * field<31, 31>(insn);
    insn_in_progress->appendOperand(makeRegisterExpression(makePowerRegID(ppc64::vsr0, id)), true,
                                    false);
  }
  ...
  void InstructionDecoder_power::UIM() {
    // fprintf(stderr, "Unimplemented operand type UIM. Please create an issue at
    // https://github.com/dyninst/dyninst/issues\n");
  }

  void InstructionDecoder_power::BHRBE() {
    // fprintf(stderr, "Unimplemented operand type BHRBE. Please create an issue at
    // https://github.com/dyninst/dyninst/issues\n");
  }

  void InstructionDecoder_power::IH() {
    // fprintf(stderr, "Unimplemented operand type IH. Please create an issue at
    // https://github.com/dyninst/dyninst/issues\n");
  }

  void InstructionDecoder_power::SP() {
    // fprintf(stderr, "Unimplemented operand type SP. Please create an issue at
    // https://github.com/dyninst/dyninst/issues\n");
  }

  void InstructionDecoder_power::S() {
    // fprintf(stderr, "Unimplemented operand type S. Please create an issue at
    // https://github.com/dyninst/dyninst/issues\n");
  }

  void InstructionDecoder_power::TE() {
    // fprintf(stderr, "Unimplemented operand type TE. Please create an issue at
    // https://github.com/dyninst/dyninst/issues\n");
  }

  void InstructionDecoder_power::DGM() {
    // fprintf(stderr, "Unimplemented operand type DGM. Please create an issue at
    // https://github.com/dyninst/dyninst/issues\n");
  }

  void InstructionDecoder_power::DCM() {
    // fprintf(stderr, "Unimplemented operand type DCM. Please create an issue at
    // https://github.com/dyninst/dyninst/issues\n");
  }

  void InstructionDecoder_power::CT() {
    //        fprintf(stderr, "Unimplemented operand type CT. Please create an issue at
    //        https://github.com/dyninst/dyninst/issues\n");
  }

  void InstructionDecoder_power::RSP() {
    //        fprintf(stderr, "Unimplemented operand type RSP. Please create an issue at
    //        https://github.com/dyninst/dyninst/issues\n");
  }

  void InstructionDecoder_power::RTP() {
    //        fprintf(stderr, "Unimplemented operand type RTP. Please create an issue at
    //        https://github.com/dyninst/dyninst/issues\n");
  }

  void InstructionDecoder_power::EH() {
    //        fprintf(stderr, "Unimplemented operand type EH. Please create an issue at
    //        https://github.com/dyninst/dyninst/issues\n");
  }

  void InstructionDecoder_power::PRS() {
    //        fprintf(stderr, "Unimplemented operand type PRS. Please create an issue at
    //        https://github.com/dyninst/dyninst/issues\n");
  }

  void InstructionDecoder_power::A() {
    //        fprintf(stderr, "Unimplemented operand type A. Please create an issue at
    //        https://github.com/dyninst/dyninst/issues\n");
  }

  void InstructionDecoder_power::R() {
    //        fprintf(stderr, "Unimplemented operand type R. Please create an issue at
    //        https://github.com/dyninst/dyninst/issues\n");
  }
  ...
  void InstructionDecoder_power::RC() {
    //        fprintf(stderr, "Unimplemented operand type RC. Please create an issue at
    //        https://github.com/dyninst/dyninst/issues\n");
  }

  void InstructionDecoder_power::RIC() {
    //        fprintf(stderr, "Unimplemented operand type RIC. Please create an issue at
    //        https://github.com/dyninst/dyninst/issues\n");
  }

  void InstructionDecoder_power::SIM() {
    //        fprintf(stderr, "Unimplemented operand type SIM. Please create an issue at
    //        https://github.com/dyninst/dyninst/issues\n");
  }

  void InstructionDecoder_power::DCMX() {
    //        fprintf(stderr, "Unimplemented operand type DCMX. Please create an issue at
    //        https://github.com/dyninst/dyninst/issues\n");
  }

  void InstructionDecoder_power::RO() {
    //        fprintf(stderr, "Unimplemented operand type RO. Please create an issue at
    //        https://github.com/dyninst/dyninst/issues\n");
  }

  void InstructionDecoder_power::RMC() {
    //        fprintf(stderr, "Unimplemented operand type RMC. Please create an issue at
    //        https://github.com/dyninst/dyninst/issues\n");
  }

  void InstructionDecoder_power::EX() {
    //        fprintf(stderr, "Unimplemented operand type EX. Please create an issue at
    //        https://github.com/dyninst/dyninst/issues\n");
  }

  void InstructionDecoder_power::SHB() {
    // fprintf(stderr, "Unimplemented operand type SHB. Please create an issue at
    // https://github.com/dyninst/dyninst/issues\n");
  }

  void InstructionDecoder_power::PS() {
    // fprintf(stderr, "Unimplemented operand type PS. Please create an issue at
    // https://github.com/dyninst/dyninst/issues\n");
  }

  void InstructionDecoder_power::CY() {
    // fprintf(stderr, "Unimplemented operand type CY. Please create an issue at
    // https://github.com/dyninst/dyninst/issues\n");
  }

  void InstructionDecoder_power::DRM() {
    // fprintf(stderr, "Unimplemented operand type DRM. Please create an issue at
    // https://github.com/dyninst/dyninst/issues\n");
  }

  void InstructionDecoder_power::SHW() {
    // fprintf(stderr, "Unimplemented operand type SHW. Please create an issue at
    // https://github.com/dyninst/dyninst/issues\n");
  }

  void InstructionDecoder_power::XC() {
    // fprintf(stderr, "Unimplemented operand type XC. Please create an issue at
    // https://github.com/dyninst/dyninst/issues\n");
  }

  void InstructionDecoder_power::DM() {
    // fprintf(stderr, "Unimplemented operand type DM. Please create an issue at
    // https://github.com/dyninst/dyninst/issues\n");
  }

  void InstructionDecoder_power::IMM8() {
    // fprintf(stderr, "Unimplemented operand type IMM8. Please create an issue at
    // https://github.com/dyninst/dyninst/issues\n");
  }
  ...
  Expression::Ptr InstructionDecoder_power::makeBTExpr() {
    return makeRegisterExpression(makePowerRegID(ppc64::cr0, field<6, 10>(insn) >> 2));
  }

  Expression::Ptr InstructionDecoder_power::makeBAExpr() {
    return makeRegisterExpression(makePowerRegID(ppc64::cr0, field<11, 15>(insn) >> 2));
  }

  Expression::Ptr InstructionDecoder_power::makeBBExpr() {
    return makeRegisterExpression(makePowerRegID(ppc64::cr0, field<16, 20>(insn) >> 2));
  }

  Expression::Ptr InstructionDecoder_power::makeCR0Expr() {
    return makeRegisterExpression(ppc64::cr0);
  }
  ...
  Expression::Ptr InstructionDecoder_power::makeSPRExpr() {
    ...
    return makeRegisterExpression(makePowerRegID(ppc64::mq, sprID));
  }
  ...
  const power_entry& InstructionDecoder_power::extended_op_4_1409() {
    ...
    const power_table::const_iterator entry_it =
        power_entry::extended_op_4_1409.find(field<11, 15>(insn));
  ...
  const power_entry& InstructionDecoder_power::extended_op_4_1538() {
    const power_table::const_iterator entry_it =
        power_entry::extended_op_4_1538.find(field<11, 15>(insn));
  ...
  const power_entry& InstructionDecoder_power::extended_op_4_1921() {
    const power_table::const_iterator entry_it =
        power_entry::extended_op_4_1921.find(field<11, 15>(insn));
  ...
  const power_entry& InstructionDecoder_power::extended_op_19() {
    const power_table::const_iterator entry_it =
        power_entry::extended_op_19.find(field<21, 30>(insn));
  ...
  const power_entry& InstructionDecoder_power::extended_op_31() {
    ...
    const power_table::const_iterator entry_it2 =
        power_entry::extended_op_31.find(field<21, 30>(insn));
  ...
  const power_entry& InstructionDecoder_power::extended_op_58() {
    const power_table::const_iterator entry_it =
        power_entry::extended_op_58.find(field<30, 31>(insn));
  ...
  const power_entry& InstructionDecoder_power::extended_op_59() {
    const power_table::const_iterator entry_it =
        power_entry::extended_op_59.find(field<21, 30>(insn));
  ...
  const power_entry& InstructionDecoder_power::extended_op_60() {
    ...
    const power_table::const_iterator entry_it =
        power_entry::extended_op_60.find(field<21, 29>(insn));
  ...
  const power_entry& InstructionDecoder_power::extended_op_60_347() {
    const power_table::const_iterator entry_it =
        power_entry::extended_op_60_347.find(field<11, 15>(insn));
  ...
  const power_entry& InstructionDecoder_power::extended_op_60_475() {
    const power_table::const_iterator entry_it =
        power_entry::extended_op_60_475.find(field<11, 15>(insn));
  ...
  const power_entry& InstructionDecoder_power::extended_op_63() {
    ...
    const power_table::const_iterator entry_it =
        power_entry::extended_op_63.find(field<21, 30>(insn));
  ...
  const power_entry& InstructionDecoder_power::extended_op_63_583() {
    const power_table::const_iterator entry_it =
        power_entry::extended_op_63_583.find(field<11, 15>(insn));
  ...
  const power_entry& InstructionDecoder_power::extended_op_63_804() {
    const power_table::const_iterator entry_it =
        power_entry::extended_op_63_804.find(field<11, 15>(insn));
  ...
  const power_entry& InstructionDecoder_power::extended_op_63_836() {
    const power_table::const_iterator entry_it =
        power_entry::extended_op_63_836.find(field<11, 15>(insn));
  ...
  void InstructionDecoder_power::FC() {
    ...
    //        fprintf(stderr, "Unimplemented operand type FC. Please create an issue at
    //        https://github.com/dyninst/dyninst/issues\n");
  }

  void InstructionDecoder_power::BF() {
    MachRegister base_reg = isFPInsn ? ppc64::fpscw0 : ppc64::cr0;
  ...
  void InstructionDecoder_power::BO() {
    ...
    {
      auto ctr = makeRegisterExpression(makePowerRegID(ppc64::ctr, 0));
  ...
  void InstructionDecoder_power::syscall() {
    insn_in_progress->appendOperand(makeRegisterExpression(ppc64::msr), true, true);
    insn_in_progress->appendOperand(makeRegisterExpression(ppc64::srr0), false, true);
    insn_in_progress->appendOperand(makeRegisterExpression(ppc64::srr1), false, true);
    insn_in_progress->appendOperand(makeRegisterExpression(ppc64::pc), true, true);
    insn_in_progress->appendOperand(makeRegisterExpression(ppc64::ivpr), false, true);
    insn_in_progress->appendOperand(makeRegisterExpression(ppc64::ivor8), false, true);
    return;
  }
  ...
  void InstructionDecoder_power::Rc() {
    if(field<31, 31>(insn)) {
      if(isFPInsn) {
        insn_in_progress->appendOperand(makeRegisterExpression(ppc64::fpscw), false, true, true);
      } else {
        insn_in_progress->appendOperand(makeCR0Expr(), false, true);
      }
  ...
  void InstructionDecoder_power::BFA() {
    Expression::Ptr condReg =
        makeRegisterExpression(makePowerRegID(ppc64::cr0, field<11, 15>(insn) >> 2));
  ...
  void InstructionDecoder_power::FXM() {
    (translateBitFieldToCR<12, 19, ppc64::icr0, 7>(*this))();
    return;
  }
  ...
  void InstructionDecoder_power::SR() {
    insn_in_progress->appendOperand(
        makeRegisterExpression(makePowerRegID(ppc64::seg0, field<11, 15>(insn) >> 2)), true, true);
    return;
  }
  ...
  void InstructionDecoder_power::U() {
    insn_in_progress->appendOperand(Immediate::makeImmediate(Result(u8, field<16, 20>(insn) >> 1)),
                                    true, false);
    return;
  }
  ...
  void InstructionDecoder_power::FLM() {
    isRAWritten = true;
    (translateBitFieldToCR<7, 14, ppc64::ifpscw0, 7>(*this))();
    return;
  }
  ...
  bool InstructionDecoder_power::findRAAndRS(const power_entry* cur) {
    ...
    for(auto oit = cur->operands.begin(); oit != cur->operands.end(); ++oit) {
      if((*oit) == &InstructionDecoder_power::RA)
        findRA = true;
      if((*oit) == &InstructionDecoder_power::RS)
        findRS = true;
    }
  ...
  void InstructionDecoder_power::mainDecode() {
    ...
    // insn_in_progress->arch_decoded_from = Arch_ppc64;
